...
const WithdrawSuccess = ({
  ...
  const claimText =
    claim.substr(0, Math.floor(claim.length / 3)) +
    " " +
    claim.substr(
      Math.floor(claim.length / 3),
      Math.floor(claim.length / 3) * 2
    );
      ...
      <Page size="A4" style={styles.page}>
          ...
          <View style={styles.depositVerify}>
            ...
            <View style={{ width: "50%", textAlign: "right" }}>
              <Text style={{ fontWeight: "bold" }}>{`${
                parsedNote.amount
              } ${parsedNote.currency.toUpperCase()}`}</Text>
            </View>
          </View>
          <View style={styles.depositContent}>
            ...
            <Text style={styles.value}>
              {location.pathname === "/inspectSuccess"
                ...
                : new Date(depReceipt?.timestamp * 1000).toUTCString()}
            </Text>
          </View>
          <View style={styles.depositContent}>
        ...
        <View style={styles.depositView}>
          ...
          <View style={styles.depositContent}>
            ...
            <Text style={styles.value}>{recipient ? recipient : txReceipt.to.toLowerCase()}</Text>
          </View>
          <View style={styles.depositContent}>
        ...
        <Box p={5}>
          <Grid container direction="column" spacing={2}>
            <Grid item>
              <br />
              <b>
                {location.pathname === "/withdrawSuccess"
                  ? t("Success!")
                  : t("Receipt")}
              </b>
            </Grid>
            ...
            <Grid item>{t("has been confirmed.")}</Grid>
            <Grid item>
              <a
                href={`https://kovan.etherscan.io/tx/${txReceipt.transactionHash.toLowerCase()}`}
                className="blue-text"
                target="_blank"
                rel="noopener noreferrer"
              >
                <b>{t("View on EtherScan")}</b>
              </a>
            </Grid>
            ...
            <Grid item>
              ...
              <PDFDownloadLink
                document={<MyDocument />}
                fileName={"sacred_compliance_report"}
